...
public class PostController {
    ...
    @PutMapping("/{postId}")
    public ResponseEntity<Post> reprocessPost(@PathVariable(name = "postId") @Min(value = 1, message = "id must be between 1 and 100") @Max(value = 100, message = "id must be between 1 and 100") Long postId) {
